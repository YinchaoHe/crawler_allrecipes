...
class googleimagesdownload:
            ...
            try:
                ...
                try:
                    if os.path.exists(path):
                        download_status = 'fail'
                        download_message = "Scraped this image before, trying next one..."
                        return_image_name = ''
                        absolute_path = ''
                        return download_status, download_message, return_image_name, absolute_path
        ...
        while count < limit + 1:
            ...
            if object == "no_links":
                ...
                download_status, download_message, return_image_name, absolute_path = self.download_image(
                    object['image_link'], object['image_format'], main_directory, dir_name, index,
    ...
    def download_executor(self, arguments):
        ...
        if arguments['output_directory']:
            ...
            main_directory = os.getcwd() + "/images"
