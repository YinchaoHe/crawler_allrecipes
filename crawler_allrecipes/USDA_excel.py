...
def main():
    ...
    for item in FDCID:
        ...
        for nutrient_info in data["foodNutrients"]:
            ...
            if nutrient['id'] == 1004 or nutrient['id'] == 1253 or nutrient['id'] ==  1093 or nutrient['id'] == 1092 or nutrient['id'] == 2039 or nutrient['id'] == 1079 or nutrient['id'] == 1003 or nutrient['id'] == 2000:
